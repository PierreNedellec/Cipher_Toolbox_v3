...
```
python cli.py monosub_break ""
```

(This is a ciphertext of the Declaration of the Rights of Man, ~500 letters —
long enough that the hill-climb reliably converges on the exact key. On much
shorter ciphertexts the search is more likely to settle for a close-but-not-
perfect substitution, since letters that barely appear are underdetermined.)
...
See the `monosub_break` example above for the cryptanalysis engine's headline result.
